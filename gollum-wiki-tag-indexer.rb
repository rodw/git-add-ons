...
options = { :tagpattern => "(Tag[A-Z][^\.]+)",  :wikifilepattern => "^([^\.]+)\.md$", :directory => ".", :metatag => "TagTag"  }
...
opt_parser = OptionParser.new do |opt|
  ...
  options[:tagfilepattern] = "^#{options[:tagpattern]}\.md$"
...
unless options[:help]
  ...
  put "  Searching for wiki pages and tags..." unless options[:silent]
